#ifndef W5500_EMAC_H_
#define W5500_EMAC_H_
...
#define W5500_HWADDR_SIZE 6U

class W5500EMAC : public EMAC {
public:
  W5500EMAC(SPIClass& spi = SPI);

  static W5500EMAC& get_instance(void);
...
private:
  ...
  SPIClass& spi;
  Wiznet5500 driver;
  uint8_t macAddr[W5500_HWADDR_SIZE];

  int receiveTaskHandle = 0;
